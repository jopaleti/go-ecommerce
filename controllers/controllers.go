...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// Check if user with the email has already registered
		...
		if inserterr != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Failed to create the user account"})
			return
		}
		defer cancel()
...
func ProductViewerAdmin() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if anyerr != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "Product not inserted successfully"})
			return
		}
		defer cancel()
